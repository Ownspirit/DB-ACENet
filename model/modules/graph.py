...
class GCN(nn.Module):
    ...
    def _init_spatial_adj(self):
        ...
        if self.num_nodes == 18:
            self.connections = {10: [9,17], 9: [8, 10,17], 8: [7, 9, 17], 14: [15, 8,17], 15: [16, 14,17], 11: [12, 8,17], 12: [13, 11,17],
               7: [0, 8, 17], 0: [1, 7, 17], 1: [2, 0, 17], 2: [3, 1, 17], 4: [5, 0, 17], 5: [6, 4, 17], 16: [15, 17], 13: [12, 17], 3: [2, 17], 6: [5, 17]
