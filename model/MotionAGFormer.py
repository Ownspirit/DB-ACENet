...
class AGFormerBlock(nn.Module):
    ...
    def __init__(self, dim, mlp_ratio=4., act_layer=nn.GELU, attn_drop=0., drop=0., drop_path=0.,
                 ...
                 temporal_connection_len=1, neighbour_num=4, n_frames=243, num_joints=17):
        super().__init__()
...
class MotionAGFormerBlock(nn.Module):
    ...
    def __init__(self, dim, mlp_ratio=4., act_layer=nn.GELU, attn_drop=0., drop=0., drop_path=0.,
                 ...
                 temporal_connection_len=1, use_tcn=False, graph_only=False, neighbour_num=4, n_frames=243, num_joints=17):
        super().__init__()
